...
export function TopAnalysis({ employees }: GetManagerEmployeesResponseProps) {
  ...
  return (
    <div className="w-full min-h-[30rem] rounded-[10px] bg-white dark:bg-[#311a42] px-7.5 py-6 shadow-md max-w-[75rem] mx-auto">
