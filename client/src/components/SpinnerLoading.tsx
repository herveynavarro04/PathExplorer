// components/ui/SpinnerLoading.tsx
"use client";
...
const SpinnerLoading = ({
  ...
  return (
    <div
      className="absolute z-50 pointer-events-none bg-transparent"
      style={{
        top: `${spinnerOffsetY}px`,
        left: spinnerOffsetX !== undefined ? `${spinnerOffsetX}px` : undefined,
        right: spinnerOffsetX === undefined ? "0px" : undefined,
        width: spinnerOffsetX === undefined ? "100%" : "auto",
        display: "flex",
    ...
    >
      <div role="status">
        <svg
          aria-hidden="true"
          className="w-10 h-10 animate-spin text-gray-200 dark:text-gray-600 fill-[#4b1196]"
          viewBox="0 0 100 101"
          fill="none"
