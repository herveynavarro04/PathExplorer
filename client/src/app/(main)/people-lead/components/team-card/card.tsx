...
import { getEquipo } from "../fetch"; // Ajusta la ruta según tu estructura
        ...
        <div className="h-full rounded-[10px] bg-[#f8f6fa] pt-2 p-6 shadow-1 dark:bg-[#311a42] ">
            ...
            <div className="w-full max-h-[700px] flex gap-6  px-4 py-4 overflow-x-auto ">
                {team.map((member, i) => (
                        <div
                            key={i}
                            className="max-h-[700px] flex-shrink-0 basis-[20%] flex flex-col items-center text-center px-2 hover:bg-[#C8B5DCFF] dark:hover:bg-[#76598a] hover:scale-100 hover:cursor-pointer rounded-[10px]"
                        >
