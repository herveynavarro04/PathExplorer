    ...
    return (
        ...
        <div className="bg-[#f8f6fa] text-dark-5 dark:bg-[#411F57FF] dark:text-dark-6 rounded-xl shadow-lg p-6 text-center relative w-[400px]">
            ...
            <div className="rounded-xl">
                <input type= "text" className="w-full bg-[#e6d6f5] dark:bg-[#C3ABD9FF] text-[#5a3bb3] font-semibold py-3 px-7 rounded-xl mb-6 text-center" placeholder="Puesto dentro del proyecto"/>
            </div>
            {!added ? (
                <button
                    onClick={handleAdd} 
